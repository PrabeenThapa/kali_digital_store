...
class TestCheckSubChannel:
    ...
    async def test_member_returns_true(self):
        from apps.telegram_bot.handlers.other import check_sub_channel
        member = MagicMock()
...
class TestAnyPaymentMethodEnabled:
    ...
    def test_all_enabled(self):
        from apps.telegram_bot.handlers.other import _any_payment_method_enabled
        with patch('apps.telegram_bot.handlers.other.EnvKeys') as env:
...
class TestIsSafeItemName:
    ...
    def test_valid_name(self):
        from apps.telegram_bot.handlers.other import is_safe_item_name
