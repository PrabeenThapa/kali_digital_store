...
from packages.database.methods.read import check_user, get_role_id_by_name, check_role_name_by_id, select_max_role_id, get_item_info

class TestCheckUserData:

    async def test_check_valid_user(self, make_message, fsm_context, user_factory):
        from apps.telegram_bot.handlers.admin.user_management_states import check_user_data
...
class TestAssignRole:
    ...
    async def test_assign_role(self, make_callback_query, user_factory):
        ...
        with patch('apps.telegram_bot.handlers.admin.role_management_states.check_role_cached', new_callable=AsyncMock, return_value=1023):
    ...
    async def test_assign_user_role(self, make_callback_query, user_factory):
        ...
        with patch('apps.telegram_bot.handlers.admin.role_management_states.check_role_cached', new_callable=AsyncMock, return_value=127):
            await assign_role_confirm(call)
...
class TestReplenishBalance:
    ...
    async def test_replenish_user_balance(self, make_message, fsm_context, user_factory):
        from apps.telegram_bot.handlers.admin.user_management_states import process_replenish_user_balance
    ...
    async def test_deduct_user_balance(self, make_message, fsm_context, user_factory):
        from apps.telegram_bot.handlers.admin.user_management_states import process_deduct_user_balance
...
class TestBlockUser:
    ...
    async def test_block_user(self, make_callback_query, user_factory):
        from apps.telegram_bot.handlers.admin.user_management_states import block_user_handler
        ...
        with patch('apps.telegram_bot.main.auth_middleware', mock_auth):
    ...
    async def test_unblock_user(self, make_callback_query, user_factory):
        from apps.telegram_bot.handlers.admin.user_management_states import unblock_user_handler
...
class TestCategoryManagement:
    ...
    async def test_add_category(self, make_message, fsm_context):
        from apps.telegram_bot.handlers.admin.categories_management_states import process_category_for_add
    ...
    async def test_delete_category(self, make_message, fsm_context, category_factory):
        from apps.telegram_bot.handlers.admin.categories_management_states import process_category_for_delete
    ...
    async def test_rename_category(self, make_message, fsm_context, category_factory):
        from apps.telegram_bot.handlers.admin.categories_management_states import (
...
class TestGoodsManagement:
    ...
    async def test_delete_item(self, make_message, fsm_context, item_factory):
        from apps.telegram_bot.handlers.admin.goods_management_states import delete_str_item
    ...
    async def test_show_items_not_found(self, make_message, fsm_context):
        from apps.telegram_bot.handlers.admin.goods_management_states import show_str_item
