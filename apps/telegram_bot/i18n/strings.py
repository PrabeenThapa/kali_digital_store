...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "btn.rules": "⚜️ Правила",
        "btn.profile": "💠 Профиль",
        "btn.support": "🛎️ Поддержка",
        "btn.channel": "📰 Новостной канал",
        "btn.admin_menu": "🎛️ Панель администратора",
        "btn.back": "🔙 Назад",
        "btn.to_menu": "🏛️ В меню",
        "btn.close": "✕ Закрыть",
        "btn.buy": "🛍️ Купить",
        "btn.yes": "☑️ Да",
        "btn.no": "⛔ Нет",
        ...
        "btn.admin.view_profile": "👁️‍🗨️ Посмотреть профиль",
        "btn.admin.promote": "⇡ Назначить администратором",
        "btn.admin.demote": "⇣ Снять администратора",
        "btn.admin.replenish_user": "💲 Пополнить баланс",
        "btn.admin.deduct_user": "🪙 Списать с баланса",
        "btn.admin.block": "⛔ Заблокировать",
        "btn.admin.unblock": "☑️ Разблокировать",
        ...
        "profile.registration_date": "🕰️ <b>Дата регистрации</b> — <code>{dt}</code>",

        # === Referral ===
        "referral.title": "💎 Реферальная система",
        "referral.link": "⛓️ Ссылка: https://t.me/{bot_username}?start={user_id}",
        ...
        "referral.description": (
            ...
            "📦 Плюс {signup_bonus:g} USDT сразу за каждого нового пользователя, "
            "который зарегистрируется по Вашей ссылке."
        ),
        "btn.view_referrals": "🫂 Мои рефералы",
        "btn.view_earnings": "🪙 Мои поступления",
        "btn.back_to_referral": "🔙 К реферальной системе",
        ...
        "admin.menu.shop": "🛍️ Управление магазином",
        "admin.menu.goods": "📦 Управление позициями",
        "admin.menu.categories": "🗂️ Управление категориями",
        "admin.menu.users": "🫂 Управление пользователями",
        "admin.menu.broadcast": "🖋️ Рассылка",
        "admin.menu.roles": "🛡️ Управление ролями",
        "admin.menu.rights": "Недостаточно прав",

        # === Admin: Role Management ===
        "admin.roles.list_title": "🛡️ Роли системы:",
        "admin.roles.create": "✚ Создать роль",
        "admin.roles.edit": "✎ Редактировать",
        "admin.roles.delete": "🚮 Удалить",
        "admin.roles.detail": "🛡️ <b>Роль</b>: {name}\n🧾 Права: {perms}\n🫂 Пользователей: {users}",
        "admin.roles.prompt_name": "Введите название роли (макс. 64 символа):",
        "admin.roles.name_invalid": "⚠ Некорректное название (пустое или длиннее 64 символов).",
        "admin.roles.name_exists": "⛔ Роль с таким именем уже существует",
        "admin.roles.select_perms": "Выберите права для роли «{name}»:",
        "admin.roles.confirm": "☑️ Подтвердить",
        "admin.roles.created": "☑️ Роль «{name}» создана",
        "admin.roles.updated": "☑️ Роль «{name}» обновлена",
        "admin.roles.deleted": "☑️ Роль удалена",
        "admin.roles.delete_confirm": "Вы уверены, что хотите удалить роль «{name}»?",
        "admin.roles.delete_fail": "⛔ Не удалось удалить: {error}",
        "admin.roles.perm_denied": "⚠ Недостаточно прав для этого действия",
        "admin.roles.assign_prompt": "Выберите роль для пользователя {id}:",
        "admin.roles.assigned": "☑️ Роль {role} назначена пользователю {name}",
        "admin.roles.assigned_notify": "📰 Вам назначена роль: {role}",
        "admin.roles.edit_name_prompt": "Введите новое название роли (или /skip чтобы оставить текущее):",
        "btn.admin.assign_role": "🛡️ Назначить роль",

        # === Admin: User Management ===
        "admin.users.prompt_enter_id": "💠 Введите id пользователя,\nчтобы посмотреть | изменить его данные",
        "admin.users.invalid_id": "⚠ Введите корректный числовой ID пользователя.",
        ...
        "admin.users.role": "🎛️ <b>Роль</b> — {role}",
        "admin.users.set_admin.success": "☑️ Роль присвоена пользователю {name}",
        "admin.users.set_admin.notify": "☑️ Вам присвоена роль АДМИНИСТРАТОРА бота",
        "admin.users.remove_admin.success": "☑️ Роль отозвана у пользователя {name}",
        "admin.users.remove_admin.notify": "⛔ У вас отозвана роль АДМИНИСТРАТОРА бота",
        "admin.users.balance.topped": "☑️ Баланс пользователя {name} пополнен на {amount} {currency}",
        "admin.users.balance.topped.notify": "☑️ Ваш баланс пополнен на {amount} {currency}",
        "admin.users.balance.deducted": "☑️ С баланса пользователя {name} списано {amount} {currency}",
        "admin.users.balance.deducted.notify": "📰 С вашего баланса списано {amount} {currency}",
        ...
        "admin.users.unblocked.success": "☑️ Пользователь {name} разблокирован",
        ...
        "admin.categories.rename": "✎ Переименовать категорию",
        ...
        "admin.categories.add.success": "☑️ Категория создана",
        "admin.categories.delete.not_found": "⛔ Категория не удалена (такой категории не существует)",
        "admin.categories.delete.success": "☑️ Категория удалена",
        ...
        "admin.categories.rename.success": "☑️ Категория \"{old}\" переименована в \"{new}\"",
        ...
        "admin.goods.update_position": "🖋️ Изменить позицию",
        ...
        "admin.goods.add.price.invalid": "⚠ Некорректное значение цены. Введите число.",
        "admin.goods.add.prompt.category": "🗂️ Выберите категорию для позиции:",
        "admin.goods.add.category.not_found": "⛔ Позиция не может быть создана (категория для привязки введена неверно)",
        "admin.goods.add.category.none_exist": "⛔ Категорий не найдено. Сначала создайте категорию.",
        ...
        "admin.goods.add.values.added": "☑️ Товар «{value}» добавлен в список ({count} шт.)",
        "admin.goods.add.result.created": "☑️ Позиция создана.",
        ...
        "admin.goods.add.single.empty": "⚠ Значение не может быть пустым.",
        "admin.goods.add.single.created": "☑️ Позиция создана, значение добавлено",
        "btn.add_values_finish": "Добавить указанные товары",
        "admin.goods.position.not_found": "⛔ Товаров нет (Такой позиции не существует)",
        "admin.goods.list_in_position.empty": "📰 В этой позиции пока нет товаров.",
        ...
        "admin.goods.update.values.result.title": "☑️ Товары добавлены",
        ...
        "admin.goods.update.success": "☑️ Позиция обновлена",
        ...
        "payments.topped_simple": "☑️ Баланс пополнен на {amount} {currency}",
        "payments.topped_with_suffix": "☑️ Баланс пополнен на {amount} {currency} ({suffix})",
        "payments.success_suffix.stars": "Telegram Stars",
        "payments.success_suffix.tg": "Telegram Payments",
        "payments.referral.bonus": "☑️ Вы получили {amount} {currency} от вашего реферала <a href='tg://user?id={id}'>{name}</a>",
        ...
        "payments.already_processed": "Этот платеж уже был обработан ☑️",
        ...
        "shop.purchase.success": "☑️ Товар куплен. <b>Баланс</b>: <i>{balance}</i> {currency}\n\n{value}",
        "shop.purchase.receipt": "☑️ Заказ успешно оформлен!\n➖➖➖➖➖➖➖➖➖➖➖➖\n📃 Товар: {item_name}\n🪙 Цена: {price} {currency}\n📦 Кол-во: 1 шт.\n💡 Заказ: {unique_id}\n🕐 Время: {datetime}\n💲 Итого: {price} {currency}\n💠 Покупатель: @{username} ({user_id})\n➖➖➖➖➖➖➖➖➖➖➖➖\n🔑 Значение:\n<code>{value}</code>",
        ...
        "middleware.above_limits": "⚠ Слишком много запросов! Вы временно заблокированы.",
        "middleware.waiting": "⏳ Подождите {time} секунд перед следующим действием.",
        "middleware.security.session_outdated": "⚠ Сессия устарела. Пожалуйста, начните заново.",
        ...
        "middleware.security.invalid_csrf": "⚠ Сессия устарела. Пожалуйста, попробуйте снова.",
        ...
        "admin.maintenance.enabled": "☑️ Режим тех. работ включён",
        "admin.maintenance.disabled": "☑️ Режим тех. работ выключён",
        ...
        "admin.promo.created": "☑️ Промокод <code>{code}</code> создан!",
        "admin.promo.code_exists": "⛔ Промокод с таким кодом уже существует.",
        "admin.promo.deleted": "☑️ Промокод удалён.",
        "admin.promo.toggled_on": "☑️ Промокод активирован.",
        ...
        "promo.applied": "☑️ Промокод <code>{code}</code> применён! Скидка: {discount}",
        ...
        "promo.balance_redeemed": "☑️ Промокод <code>{code}</code> активирован! На баланс начислено {amount} {currency}.",
        ...
        "review.created": "☑️ Спасибо за отзыв!",
        ...
        "review.list_title": "🖋️ <b>Отзывы на {name}</b>",
    ...
    "en": {
        ...
        "btn.rules": "⚜️ Rules",
        "btn.profile": "💠 Profile",
        "btn.support": "🛎️ Support",
        "btn.channel": "Public discussion group",
        "btn.admin_menu": "🎛️ Admin panel",
        "btn.back": "🔙 Back",
        "btn.to_menu": "🏛️ Menu",
        "btn.close": "✕ Close",
        "btn.buy": "🛍️ Buy",
        ...
        # === Admin Buttons (user management shortcuts) ===
        "btn.admin.view_profile": "👁️‍🗨️ View profile",
        "btn.admin.promote": "⇡ Make admin",
        "btn.admin.demote": "⇣ Remove admin",
        "btn.admin.replenish_user": "💲 Top up balance",
        "btn.admin.deduct_user": "🪙 Deduct from balance",
        "btn.admin.block": "⛔ Block",
        "btn.admin.unblock": "☑️ Unblock",
        ...
        # === Subscription Flow ===
        "subscribe.prompt": "First, subscribe to the Public discussion group and KDS alert ☑️",
        ...
        "profile.registration_date": "🕰️ <b>Registered at</b> — <code>{dt}</code>",

        # === Referral ===
        "referral.title": "💎 Referral system",
        "referral.link": "⛓️ Link: https://t.me/{bot_username}?start={user_id}",
        "referral.count": "Referrals count: {count}",
        "referral.description": (
            "🧾 The referral system lets you earn without any investment. "
            "Share your personal link and get {signup_bonus:g} USDT credited "
            "instantly for each new user who signs up through your link."
        ),
        "btn.view_referrals": "🫂 My referrals",
        "btn.view_earnings": "🪙 My earnings",
        "btn.back_to_referral": "🔙 Back to referral system",
        ...
        "admin.menu.shop": "🛍️ Shop management",
        "admin.menu.goods": "📦 Items management",
        "admin.menu.categories": "🗂️ Categories management",
        "admin.menu.users": "🫂 Users management",
        "admin.menu.broadcast": "🖋️ Broadcast",
        "admin.menu.roles": "🛡️ Role management",
        "admin.menu.rights": "Insufficient permissions",

        # === Admin: Role Management ===
        "admin.roles.list_title": "🛡️ System roles:",
        "admin.roles.create": "✚ Create role",
        "admin.roles.edit": "✎ Edit",
        "admin.roles.delete": "🚮 Delete",
        "admin.roles.detail": "🛡️ <b>Role</b>: {name}\n🧾 Permissions: {perms}\n🫂 Users: {users}",
        "admin.roles.prompt_name": "Enter the role name (max 64 characters):",
        "admin.roles.name_invalid": "⚠ Invalid name (empty or exceeds 64 characters).",
        "admin.roles.name_exists": "⛔ A role with this name already exists",
        "admin.roles.select_perms": "Select permissions for role \"{name}\":",
        "admin.roles.confirm": "☑️ Confirm",
        "admin.roles.created": "☑️ Role \"{name}\" created",
        "admin.roles.updated": "☑️ Role \"{name}\" updated",
        "admin.roles.deleted": "☑️ Role deleted",
        "admin.roles.delete_confirm": "Are you sure you want to delete the role \"{name}\"?",
        "admin.roles.delete_fail": "⛔ Failed to delete: {error}",
        "admin.roles.perm_denied": "⚠ Insufficient permissions for this action",
        "admin.roles.assign_prompt": "Select a role for user {id}:",
        "admin.roles.assigned": "☑️ Role {role} assigned to {name}",
        "admin.roles.assigned_notify": "📰 Your role has been set to: {role}",
        "admin.roles.edit_name_prompt": "Enter the new role name (or /skip to keep current):",
        "btn.admin.assign_role": "🛡️ Assign role",

        # === Admin: User Management ===
        "admin.users.prompt_enter_id": "💠 Enter the user ID to view / edit data",
        "admin.users.invalid_id": "⚠ Please enter a valid numeric user ID.",
        ...
        "admin.users.role": "🎛️ <b>Role</b> — {role}",
        "admin.users.set_admin.success": "☑️ Role assigned to {name}",
        "admin.users.set_admin.notify": "☑️ You have been granted the ADMIN role",
        "admin.users.remove_admin.success": "☑️ Admin role revoked from {name}",
        "admin.users.remove_admin.notify": "⛔ Your ADMIN role has been revoked",
        "admin.users.balance.topped": "☑️ {name}'s balance has been topped up by {amount} {currency}",
        "admin.users.balance.topped.notify": "☑️ Your balance has been topped up by {amount} {currency}",
        "admin.users.balance.deducted": "☑️ Deducted {amount} {currency} from {name}'s balance",
        "admin.users.balance.deducted.notify": "📰 {amount} {currency} has been deducted from your balance",
        ...
        "admin.users.unblocked.success": "☑️ User {name} has been unblocked",
        ...
        "admin.categories.rename": "✎ Rename category",
        ...
        "admin.categories.add.success": "☑️ Category created",
        "admin.categories.delete.not_found": "⛔ Category not deleted (does not exist)",
        "admin.categories.delete.success": "☑️ Category deleted",
        ...
        "admin.categories.rename.success": "☑️ Category \"{old}\" renamed to \"{new}\"",

        # === Admin: Goods / Items Management (Add / List / Item Info) ===
        "admin.goods.add_position": "✚ add item",
        "admin.goods.add_item": "✚ Add product to item",
        "admin.goods.update_position": "🖋️ change item",
        ...
        "admin.goods.add.price.invalid": "⚠ Invalid price. Please enter a number.",
        "admin.goods.add.prompt.category": "🗂️ Select a category for the item:",
        "admin.goods.add.category.not_found": "⛔ Item cannot be created (invalid category provided)",
        "admin.goods.add.category.none_exist": "⛔ No categories found. Please create a category first.",
        ...
        "admin.goods.add.values.added": "☑️ Value “{value}” added to the list ({count} pcs).",
        "admin.goods.add.result.created": "☑️ Item has been created.",
        ...
        "admin.goods.add.single.empty": "⚠ Value cannot be empty.",
        "admin.goods.add.single.created": "☑️ Item created, value added",
        "btn.add_values_finish": "Add the listed goods",
        "admin.goods.position.not_found": "⛔ No goods (this item doesn't exist)",
        "admin.goods.list_in_position.empty": "📰 There are no goods in this item yet.",
        ...
        "admin.goods.update.values.result.title": "☑️ Values added",
        ...
        "admin.goods.update.success": "☑️ Item updated",
        ...
        "payments.topped_simple": "☑️ Balance topped up by {amount} {currency}",
        "payments.topped_with_suffix": "☑️ Balance topped up by {amount} {currency} ({suffix})",
        "payments.success_suffix.stars": "Telegram Stars",
        "payments.success_suffix.tg": "Telegram Payments",
        "payments.referral.bonus": "☑️ You received {amount} {currency} from your referral <a href='tg://user?id={id}'>{name}</a>",
        ...
        "payments.invoice.label.stars": "{stars} 🌟️",
        "payments.already_processed": "This payment has already been processed ☑️",
        ...
        "shop.purchase.success": "☑️ Item purchased. <b>Balance</b>: <i>{balance}</i> {currency}\n\n{value}",
        "shop.purchase.receipt": "☑️ Order placed successfully!\n➖➖➖➖➖➖➖➖➖➖➖➖\n📃 Item: {item_name}\n🪙 Price: {price} {currency}\n📦 Qty: 1\n💡 Order: {unique_id}\n🕐 Time: {datetime}\n💲 Total: {price} {currency}\n💠 Buyer: @{username} ({user_id})\n➖➖➖➖➖➖➖➖➖➖➖➖\n🔑 Value:\n<code>{value}</code>",
        ...
        "middleware.above_limits": "⚠ Too many requests! You are temporarily blocked.",
        "middleware.waiting": "⏳ Wait {time} seconds for the next action.",
        "middleware.security.session_outdated": "⚠ Session is outdated. Please start again.",
        ...
        "middleware.security.invalid_csrf": "⚠ Session expired. Please try again.",
        ...
        "admin.maintenance.enabled": "☑️ Maintenance mode enabled",
        "admin.maintenance.disabled": "☑️ Maintenance mode disabled",
        ...
        "admin.promo.created": "☑️ Promo code <code>{code}</code> created!",
        "admin.promo.code_exists": "⛔ Promo code already exists.",
        "admin.promo.deleted": "☑️ Promo code deleted.",
        "admin.promo.toggled_on": "☑️ Promo code activated.",
        ...
        "promo.applied": "☑️ Promo code <code>{code}</code> applied! Discount: {discount}",
        ...
        "promo.balance_redeemed": "☑️ Promo code <code>{code}</code> redeemed! {amount} {currency} added to your balance.",
        ...
        # === Cart ===
        "btn.cart": "🛍️ Cart ({count})",
        "btn.cart_empty": "🛍️ Cart",
        "btn.add_to_cart": "🛍️ Add to cart",
        "btn.cart_checkout": "🪙 Checkout",
        "btn.cart_clear": "🚮 Clear cart",
        "cart.title": "🛍️ <b>Cart</b>",
        "cart.empty": "Cart is empty.",
        "cart.item": "• {name} — {price} {currency}",
        "cart.total": "\n🪙 <b>Total</b>: {total} {currency}",
        "cart.added": "☑️ {name} added to cart.",
        "cart.full": "⛔ Cart is full (max 10 items).",
        "cart.item_not_found": "⛔ Item not found.",
        "cart.removed": "☑️ Item removed from cart.",
        "cart.cleared": "☑️ Cart cleared.",
        "cart.checkout_confirm": "Checkout {count} item(s) for {total} {currency}?",
        "cart.checkout_success": "☑️ Order placed! Bought {count} item(s).\n\n🪙 Balance: {balance} {currency}",
        "cart.checkout_receipt": "☑️ Order placed!\n➖➖➖➖➖➖➖➖➖➖➖➖\n📦 Qty: {count}\n💲 Total: {total} {currency}\n💠 Buyer: @{username} ({user_id})\n🕐 Time: {datetime}\n➖➖➖➖➖➖➖➖➖➖➖➖\nTap an item to view details:",
        ...
        "review.created": "☑️ Thank you for your review!",
        ...
        "review.item": "🌟 {rating}/5 — {text}",
        "review.item_no_text": "🌟 {rating}/5",
        "review.list_title": "🖋️ <b>Reviews for {name}</b>",
