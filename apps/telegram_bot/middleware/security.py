...
class AuthenticationMiddleware(BaseMiddleware):
    ...
    async def __call__(
        ...
        from packages.database.methods import is_user_blocked
    ...
    async def get_user_role_cached(self, user_id: int) -> int:
        ...
        # Download from DB
        from packages.database.methods import check_role
    ...
    async def load_blocked_users(self) -> None:
        ...
        from packages.database.methods.read import get_blocked_user_ids
        try:
    ...
    async def block_user(self, user_id: int) -> bool:
        ...
        from packages.database.methods import set_user_blocked
